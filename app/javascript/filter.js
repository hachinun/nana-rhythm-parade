document.addEventListener("DOMContentLoaded", function () {
    ...
    window.filteredVideos = [];  // グローバルに filteredVideos を保存
    ...
    function filterVideos(condition) {
        ...
        window.filteredVideos = [];  // フィルタリングされたリストをリセット
        ...
        videos.forEach(video => {
            ...
            if (condition(startSeconds, isFavorite)) {
                ...
                window.filteredVideos.push(video);  // フィルタリングされた動画を格納
            } else {
    ...
    function activateFilter(button, condition) {
        ...
        console.log("フィルタリングされた動画:", window.filteredVideos); // フィルタリング後の動画リストを表示
    }
    ...
    showAllBtn.addEventListener("click", function () {
        ...
        console.log("フィルタリングされた動画:", window.filteredVideos); // すべて表示後の動画リスト
    });
});
